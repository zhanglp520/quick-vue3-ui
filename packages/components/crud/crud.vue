...
import QuickSearch from '@/components/search/search.vue'
import QuickTable from '@/components/table/table.vue'
import QuickToolbar from '@/components/toolbar/toolbar.vue'
import QuickForm from '@/components/form/form.vue'
...
const pagebar = page.value as Page
/**
 * emits
 */
  ...
  <div class="quick-crud">
    <el-row :gutter="40">
      ...
      <el-col :span="leftTree ? 24 - treeSpan : 24">
        ...
        <el-pagination
          v-if="page"
          v-model:currentPage="pagebar.current"
          v-model:page-size="pagebar.size"
          :page-sizes="pagebar.sizes"
          :small="false"
          :disabled="false"
          :background="false"
